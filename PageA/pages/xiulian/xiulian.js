...
Page({
  ...
  bindHuijianTap() {
    ...
    if ((huijian >= 900) && (shujia.indexOf('tianjianxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=tianjian',
      })
      return
    }

    wx.redirectTo({
      url: '../event/event?event=huijian',
    })
  },
  ...
  bindYujianshuTap() {
    ...
    if ((yujianshu >= 100) && (shujia.indexOf('jianqizhanxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=jianqizhan',
      })
      return
    }
    ...
    if ((yujianshu >= 300) && (shujia.indexOf('yujianfumoxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=yujianfumo',
      })
      return
    }
    ...
    if ((yujianshu >= 900) && (shujia.indexOf('jianshenxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=jianshen',
      })
      return
    }

    wx.redirectTo({
      url: '../event/event?event=yujianshu',
    })
  },
  ...
  bindBingzhouTap() {
    ...
    if ((shui >= 100) && (shujia.indexOf('xuanbingzhouxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=xuanbingzhou',
      })
      return
    }
    ...
    if ((shui >= 300) && (shujia.indexOf('fengxuebingtianxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=fengxuebingtian',
      })
      return
    }
    ...
    if ((shui >= 900) && (shujia.indexOf('xueyaoxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=xueyao',
      })
      return
    }

    wx.redirectTo({
      url: '../event/event?event=bingzhou',
    })
  },
  ...
  bindYanzhouTap() {
    ...
    if ((huo >= 100) && (shujia.indexOf('chiyanshuxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=chiyanshu',
      })
      return
    }
  ...
  bindLeizhouTap() {
    ...
    if ((lei >= 100) && (shujia.indexOf('wuleizhouxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=wuleizhou',
      })
      return
    }
    ...
    if ((lei >= 300) && (shujia.indexOf('leidongjiutianxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=leidongjiutian',
      })
      return
    }
    ...
    if ((lei >= 900) && (shujia.indexOf('leishenxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=leishen',
      })
      return
    }

    wx.redirectTo({
      url: '../event/event?event=leizhou',
    })
  },
  ...
  bindFengzhouTap() {
    ...
    if ((feng >= 100) && (shujia.indexOf('xuanfengzhouxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=xuanfengzhou',
      })
      return
    }
    ...
    wx.redirectTo({
      url: '../event/event?event=fengzhou',
    })
  },
  ...
  bindTuzhouTap() {
    ...
    if ((tu >= 100) && (shujia.indexOf('feiyuanshuxinde') == -1)) {
      ...
      wx.setStorage({ key: 'shujia', data: shujia })
      wx.redirectTo({
        url: '../event/event?event=feiyuanshu',
      })
      return
    }

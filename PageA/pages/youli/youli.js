  ...
  bindYouliTap() {
    ...
    if (shui >= 10) {
      ...
      if (random == 1 && (wuqijia.indexOf('shuilingzhu') == -1)) {
        ...
        wx.redirectTo({
          url: '../event/event?event=shuilingzhu',
        })
        return
      }
    }
    ...
    if (huo >= 10) {
      ...
      if (random == 1 && (wuqijia.indexOf('huolingzhu') == -1)) {
        ...
        wx.setStorage({ key: 'wuqijia', data: wuqijia })
        wx.redirectTo({
          url: '../event/event?event=huolingzhu',
        })
        return
      }
    }
    ...
    if (lei >= 10) {
      ...
      if (random == 1 && (wuqijia.indexOf('leilingzhu') == -1)) {
        ...
        wx.setStorage({ key: 'wuqijia', data: wuqijia })
        wx.redirectTo({
          url: '../event/event?event=leilingzhu',
        })
        return
      }
    }
    ...
    if (feng >= 10) {
      ...
      if (random == 1 && (wuqijia.indexOf('fenglingzhu') == -1)) {
        ...
        wx.setStorage({ key: 'wuqijia', data: wuqijia })
        wx.redirectTo({
          url: '../event/event?event=fenglingzhu',
        })
        return
      }
    }
    ...
    if (tu >= 10) {
      ...
      if (random == 1 && (wuqijia.indexOf('tulingzhu') == -1)) {
        ...
        wx.setStorage({ key: 'wuqijia', data: wuqijia })
        wx.redirectTo({
          url: '../event/event?event=tulingzhu',
        })
        return
      }
    }
    ...
    if (time >= 1) {
      ...
      if (random == 1 && (wuqijia.indexOf('yeyingjian') == -1)) {
        ...
        wx.setStorage({ key: 'wuqijia', data: wuqijia })
        wx.redirectTo({
          url: '../event/event?event=yeyingjian',
        })
        return
      }
    }
    ...
    if (time >= 1) {
      ...
      if (random == 1 && (wuqijia.indexOf('xuanyuanjian') == -1)) {
        ...
        wx.setStorage({ key: 'wuqijia', data: wuqijia })
        wx.redirectTo({
          url: '../event/event?event=xuanyuanjian',
        })
        return
      }
    }
